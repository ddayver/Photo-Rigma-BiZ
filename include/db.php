...
**	Decr.:	Класс по работе с базой данных									**
*****************************************************************************/
...
$db = new db($config['dbhost'], $config['dbuser'], $config['dbpass'], $config['dbname']); // создаем объект класса - устанавливаем соединение с базой данных
