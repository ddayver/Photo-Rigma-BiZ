...
define('TBL_USERS_BANS', '`user_bans`'); ///< Таблица пользователей с их банами
...
define('GROUP_GUEST', 0); ///< Группа гостей
define('GROUP_USER', 1); ///< Группа пользователей
define('GROUP_MODER', 2); ///< Группа модераторов
define('GROUP_ADMIN', 3); ///< Группа администраторов
define('DEFAULT_GROUP', GROUP_USER); ///< Группа по-умолчанию для новых пользователей
define(
    'PROTECTED_GROUPS',
    [GROUP_GUEST, GROUP_USER, GROUP_MODER, GROUP_ADMIN]
); ///< Список групп с запретом на удаление
define('MAX_LOGIN_ATTEMPTS', (int)($_ENV['MAX_LOGIN_ATTEMPTS'] ?? 5)); ///< Максимальное количество попыток входа в админку
define(
    'LOCKOUT_TIME',
    (int)($_ENV['LOCKOUT_TIME'] ?? 300)
); ///< Время блокировки после превышения попыток входа в админку (в секундах, например, 5 минут)
define('DEFAULT_AVATAR', $_ENV['DEFAULT_AVATAR'] ?? 'no_avatar.jpg'); ///< Константа для значения аватара по умолчанию
define(
    'SOFT_DELETE_RETENTION_INTERVAL',
    str_replace('_', ' ', $_ENV['SOFT_DELETE_RETENTION_INTERVAL'] ?? '3 months')
...
// Константы для настройки архивации логов
define('COMPRESSION_LEVEL', (int)($_ENV['COMPRESSION_LEVEL'] ?? 9)); ///< Уровень сжатия (максимальный)
define('LOG_LIFETIME_DAYS', str_replace('_', ' ', $_ENV['LOG_LIFETIME_DAYS'] ?? '-7 days')); ///< Срок хранения логов
define(
    'MAX_LOG_SIZE',
    (int)($_ENV['MAX_LOG_SIZE'] ?? 10485760)
