...
define('GROUP_ADMIN', 3); ///< Группа админов
...
define('MIN_FULLTEXT_SEARCH_LENGTH', 5); ///< Минимальная длина для полнотекстового поиска
define('SQL_LOG', false); ///< Включить логирование запросов без плейсхолдеров и медленных запросов
define('SQL_ANALYZE', false); ///< Включить анализ запросов с помощью EXPLAIN/EXPLAIN ANALYZE
