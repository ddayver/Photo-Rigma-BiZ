...
/**
 * Интерфейс для работы с HTML-шаблонами, включая рендеринг и подстановку данных.
 *
 * Этот файл содержит интерфейс `Template_Interface`, который определяет методы для работы с HTML-шаблонами:
 ...
 *
 * Этот интерфейс определяет контракт для работы с шаблонами, используемыми в приложении. Он предоставляет методы для
 * добавления данных, условий и строковых переменных в шаблоны, а также для формирования заголовка и подвала
 * HTML-страниц. Основные возможности:
 * - Установка объекта, реализующего интерфейс `Work_Interface`, через сеттер (`set_work`).
 * - Добавление условий вывода фрагментов шаблона (`add_if`, `add_if_array`).
 * - Добавление выбора блоков для вывода фрагментов шаблона (`add_case`, `add_case_array`).
 * - Добавление строковых данных для замены в шаблоне (`add_string`, `add_string_array`).
 ...
 * - Формирование заголовка HTML-страницы с меню, метаданными и блоками контента (`page_header`).
 * - Формирование подвала HTML-страницы с выводом копирайта, статистики, информации о пользователе и случайной
 *   фотографии (`page_footer`).
 *
...
interface Template_Interface
{
     ...
     *
     * Этот метод является частью контракта интерфейса и должен быть реализован в классе. Присваивает объект для
    ...
    /**
     * Добавляет массив данных об условиях вывода фрагментов шаблона.
     *
    ...
    /**
     * Добавляет условие вывода фрагментов шаблона.
     *
     * Этот метод является частью контракта интерфейса и должен быть реализован в классе.
     * Он выполняет следующие действия:
    ...
    /**
     * Добавляет массив данных о выборе блока для вывода фрагментов шаблона.
     *
     * Этот метод является частью контракта интерфейса и должен быть реализован в классе.
     * Он выполняет следующие действия:
     * 1. Проверяет, что массив данных не пуст. Если массив пуст, выбрасывается исключение.
    ...
    /**
     * Добавляет данные о выборе блока для вывода фрагментов шаблона.
     *
     * Этот метод является частью контракта интерфейса и должен быть реализован в классе.
     * Он выполняет следующие действия:
     * 1. Проверяет корректность имени условия (только латинские буквы, цифры и подчеркивания). Если имя некорректно,
    ...
    /**
     * Добавляет массив строковых данных для замены в шаблоне.
     *
     * Этот метод является частью контракта интерфейса и должен быть реализован в классе.
     * Он выполняет следующие действия:
     * 1. Проверяет, что массив данных не пуст. Если массив пуст, выбрасывается исключение.
    ...
    /**
     * Добавляет строковую переменную для замены в шаблоне.
     *
     * Этот метод является частью контракта интерфейса и должен быть реализован в классе.
     * Он выполняет следующие действия:
     ...
     * 3. Если указан путь (`$path_array`), проверяет его формат (строка или `false`). Если путь указан, добавляет
     *    переменную рекурсивно.
    ...
    /**
     * Создает и обрабатывает шаблон, включая чтение файла, парсинг и замену плейсхолдеров.
     *
     * Этот метод является частью контракта интерфейса и должен быть реализован в классе.
     * Он выполняет следующие действия:
    ...
    /**
     * Формирует заголовок HTML-страницы с меню, метаданными и блоками контента.
     *
     * Этот метод является частью контракта интерфейса и должен быть реализован в классе.
     * Он выполняет следующие действия:
    ...
    /**
     * Формирует подвал HTML-страницы с выводом копирайта, статистики, информации о пользователе и случайной фотографии.
     *
     * Этот метод является частью контракта интерфейса и должен быть реализован в классе.
     * Он выполняет следующие действия:
