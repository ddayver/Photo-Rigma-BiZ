 ...
 *
 * @see       PhotoRigma::Interfaces::Cache_Handler_Interface Интерфейс обработчика кеша, используемый реализациями Database_Interface.
 */
interface Database_Interface
{
    /**
