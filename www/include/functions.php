 ...
 *              Функции обеспечивают безопасное управление логами, включая архивацию старых файлов и запись новых
 *              данных. Реализованы меры безопасности, такие как проверка доступа к файлам и директориям, ограничение
 *              размера логов и использование блокировок при записи.
 *
