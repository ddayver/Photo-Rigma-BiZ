<?php
/**
* @file		language/russian/menu.php
* @brief	Переменные языка для пунктов меню сайта (русский)
* @author	Dark Dayver
* @version	0.1.1
* @date		27/03-2012
* @details	Содержит переменные языка для пунктов меню сайта (русский). Более подробная информация в группе @ref LanguageRussian
*/
/// @cond
if (IN_GALLERY)
{
