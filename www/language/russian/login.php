...
* @brief	Переменные языка для процедур регистрации и восстановления пароля (русский)
* @author	Dark Dayver
* @version	0.1.1
* @date		27/03-2012
* @details	Содержит переменные языка для процедур регистрации и восстановления пароля (русский). Более подробная информация в группе @ref LanguageRussian
*/
/// @cond
if (IN_GALLERY !== true)
{
