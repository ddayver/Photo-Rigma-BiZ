 ...
 * @brief       Содержит локализованные строки для основного ядра сайта на русском языке.
 *
 * @author      Dark Dayver
 * @version     0.4.0
 * @date        2025-02-17
 ...
 *
 * @details     Содержит строки русского языка, используемые в ядре проекта сайта.
 *
 * @see         @ref LanguageRussian Группа для русской локализации.
 *
 * @note        Этот файл является частью системы PhotoRigma и содержит локализацию проекта на русском языке.
 *
...
$lang = [
    'main' => [
        ...
        'redirect_description' => 'Сейчас произойдет автоматический переход на страницу сайта',
        'redirect_url' => 'Нажмите здесь если Ваш браузер не поддерживает переадресацию',
        'login_ok' => ', вход успешно выполнен!',
        ...
        'stat_category' => 'Всего разделов (из них пользовательских)',
...
$lang += [
    'category' => [
        ...
        'confirm_delete1' => 'Вы уверены, что хотите удалить раздел',
...
$lang += [
    'photo' => [
        ...
        'confirm_delete' => 'Вы уверены, что хотите удалить изображение',
        'filename' => 'Изменить',
        'save' => 'Изменить',
        'cancel' => 'Отменить',
...
$lang += [
    'admin' => [
        ...
        'meta_description_description' => 'Мета-тег описания сайта используется поисковиками для отображения проиндексированого сайта в базах - должен кратко описывать назначение сайта',
        'meta_keywords' => 'Мета-тег ключевых слов',
        'meta_keywords_description' => 'Мета-тег ключевых слов используется поисковиками для индексирования сайта в базах - укажите через пробел ключевые слова, отображающие суть сайта',
        'appearance_settings' => 'Внешний вид сайта',
        'gal_width' => 'Ширина галлереи',
        'gal_width_description' => 'Ширина галлереи позволяет настроить отображаемую ширину всей галлереи, можно указать в пикселях или процентах',
        'left_panel' => 'Ширина левой колонки',
        'left_panel_description' => 'Ширина левой колонки сайта, можно указать в пикселях или процентах',
        'right_panel' => 'Ширина правой колонки',
        'right_panel_description' => 'Ширина правой колонки сайта, можно указать в пикселях или процентах',
        'language' => 'Язык сайта',
        'language_description' => 'Выбор языка сайта из существующих',
        'themes' => 'Шаблон сайта',
        'themes_description' => 'Выбор шаблона сайта из существующих',
        'size_settings' => 'Используемые размеры',
        'max_file_size' => 'Максимальный объем загружаемого файла',
        'max_file_size_description' => 'Максимальный объем загружаемого файла, можно указать в байтах, кило-, мега- и гиго-байтах. Если указанный размер превышает допустимый в настройках PHP, то будет установлен указанный в настройках PHP.',
        'max_photo' => 'Максимальный размер изображений',
        'max_photo_description' => 'Максимальный размер изображения, до которого будет сжато отображаемое загруженное изображение на страницах сайта (в пикселях в виде ВЫСОТА х ШИРИНА)',
        'temp_photo' => 'Максимальный размер эскизов',
        'temp_photo_description' => 'Максимальный размер эскизов изображений, отображаемых в списках категорий, в блоках сайта (в пикселях в виде ВЫСОТА х ШИРИНА)',
        'max_avatar' => 'Максимальный размер аватар',
        'max_avatar_description' => 'Максимальный размер аватар, загружаемых пользователями в свой профиль (в пикселях в виде ВЫСОТА х ШИРИНА)',
        ...
        'last_news_description' => 'Количество последних отображаемых новостей на главной странице сайта',
        'best_user' => 'Лучшие пользователи',
        'best_user_description' => 'Количество отображаемых лучших пользователей',
        ...
        'help_search_user' => 'Для отображения всех пользователей используйте "*" как шаблон для поиска',
