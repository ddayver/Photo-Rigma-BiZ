 ...
 * @brief Используется для указания, что сервер является локальным и не все его пользователи могут иметь доступ в интернет (ограничивает загрузку JS и CSS с интернета).
 */
