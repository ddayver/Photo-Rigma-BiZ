...
$lang_ru += [
    'profile' => [
        ...
        'soft_delete_user'         => 'Удалить свой аккаунт',
        'confirm_soft_delete_user' => 'Вы уверены, что хотите удалить свой аккаунт? Для восстановления достаточно войти на сайт до: %s.',
        'user_deleted_at'          => 'Дата мягкого удаления',
        'user_restore_expiry'      => 'Срок восстановления до',
    ],
];
...
$lang_ru += [
    'admin' => [
        ...
        'hard_delete_user'              => 'Мгновенно удалить пользователя',
        'confirm_hard_delete_user'      => 'Вы действительно xотите окончательно удалить этого пользователя? Это действие нельзя отменить.',
