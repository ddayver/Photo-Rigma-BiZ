...
/**
 * Обзор и управление разделами галереи.
 *
 * Этот файл отвечает за отображение, редактирование, удаление и добавление разделов в галерею.
 * Основные функции:
 ...
 *
 * @section   Category_Related_Components Связанные компоненты
 *            - Классы приложения:
