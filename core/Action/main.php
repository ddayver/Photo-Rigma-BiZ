...
/**
 * Главная страница. Формирует и выводит последние новости проекта, проверяя права пользователя на их просмотр.
 *
 * Этот файл отвечает за формирование главной страницы сайта. Основная логика включает:
 ...
 *
 * @section   Main_Related_Components Связанные компоненты
 *            - Классы приложения:
