...
[
    ...
    [ "Переменные для пунктов меню сайта", "group__LanguageRussianMenu.html", null ],
    [ "Переменные для новостей сайта", "group__LanguageRussianNews.html", null ],
    [ "Переменные для процедур вывода, обработки, оценки изображений", "group__LanguageRussianPhoto.html", null ],
    [ "Переменные для страницы поиска", "group__LanguageRussianSearch.html", null ]
];